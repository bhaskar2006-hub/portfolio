    ...
    <Section id="about">
      ...
      <div className="grid gap-6 lg:grid-cols-12">
        ...
        <motion.div
          ...
          className="relative overflow-hidden rounded-3xl border border-border/80 bg-white/90 p-8 shadow-xl backdrop-blur-xl lg:col-span-7 flex flex-col justify-between"
        >
          {/* Ambient Glow */}
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 mb-6">
              <div className="relative shrink-0">
                <div className="h-24 w-24 sm:h-28 sm:w-28 overflow-hidden rounded-2xl border-2 border-primary/40 shadow-lg shadow-orange-500/10 bg-muted">
                  <img
                    src={profile.avatar}
                    alt={profile.name}
                ...
                <div className="absolute -bottom-1 -right-1 h-5 w-5 rounded-full border-2 border-white bg-orange-500" title="Available for work" />
              </div>
          ...
          <div className="mt-8 grid grid-cols-3 gap-3 border-t border-border/80 pt-6">
            <div className="rounded-2xl border border-border/80 bg-slate-50/80 p-4 backdrop-blur-sm shadow-sm">
            ...
            <div className="rounded-2xl border border-border/80 bg-slate-50/80 p-4 backdrop-blur-sm shadow-sm">
              <div className="font-mono text-2xl font-black text-orange-600">AWS</div>
        ...
        >
          ...
          <div className="my-5 space-y-3 font-mono text-xs">
            <div className="flex items-center justify-between rounded-xl border border-orange-500/30 bg-orange-500/5 p-3 text-orange-950">
              <div className="flex items-center gap-2.5">
                <Globe className="h-4 w-4 text-orange-500" />
                <span className="font-semibold">Client Tier</span>
              </div>
              <span className="text-[11px] text-orange-700">React 19 · SPA · Context API</span>
            </div>
            ...
            <div className="flex items-center justify-between rounded-xl border border-amber-500/30 bg-amber-500/5 p-3 text-amber-950">
              <div className="flex items-center gap-2.5">
                <Server className="h-4 w-4 text-amber-600" />
                <span className="font-semibold">API Gateway Tier</span>
              </div>
              <span className="text-[11px] text-amber-700">Node.js · Express · JWT Auth</span>
            </div>
            ...
            <div className="flex items-center justify-between rounded-xl border border-yellow-500/30 bg-yellow-500/5 p-3 text-yellow-950">
              <div className="flex items-center gap-2.5">
                <Database className="h-4 w-4 text-yellow-600" />
                <span className="font-semibold">Database &amp; Cloud</span>
              </div>
              <span className="text-[11px] text-yellow-700">MongoDB Atlas · AWS EC2</span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between rounded-xl border border-border bg-slate-50/90 px-3.5 py-2 text-xs text-muted-foreground">
            ...
            <span className="text-orange-600 font-mono text-[11px] font-bold">● Active</span>
          </div>
        </motion.div>
        ...
        {coreStrengths.map((item, i) => {
          ...
          return (
            <motion.div
              ...
              className="group rounded-2xl border border-border/80 bg-white/90 p-5 shadow-lg backdrop-blur-md transition-all hover:border-primary/50 hover:shadow-xl hover:translate-y-[-2px] lg:col-span-3 sm:col-span-6"
            >
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-orange-500/10 text-primary transition-colors group-hover:bg-primary group-hover:text-white mb-3">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {skillGroups.map((group, i) => (
          <motion.div
            ...
            className="group rounded-2xl border border-border/80 bg-white/90 p-5 shadow-lg backdrop-blur-md transition-all hover:border-primary/40 hover:shadow-xl"
          >
            <div className="mb-3.5 flex items-center justify-between border-b border-border/80 pb-2.5">
            ...
            <div className="flex flex-wrap gap-2">
              {group.items.map((item) => (
                <span
                  key={item}
                  className="rounded-lg border border-border/80 bg-slate-50 px-2.5 py-1 text-xs font-medium text-slate-700 transition-colors hover:border-primary/50 hover:bg-orange-500/5 hover:text-primary"
                >
                  {item}
                </span>
              ))}
